<template>
  <div class="order">
    <div class="address">
      <div class="item" v-if="address.name" @click="toAddressList">
        <div class="list">
          <div class="addresslist">
            ...
            <div class="info">
              <p>{{address.mobile}}</p>
              <p>{{address.address_detail+address.address_detail}}</p>
            </div>
            <div></div>
          </div>
        </div>
      </div>
      <div class="seladdress" v-else @click="toAdd">请选择收货地址</div>
    </div>
    <div class="orderbox">
      <div class="item">
        <div>商品合计</div>
